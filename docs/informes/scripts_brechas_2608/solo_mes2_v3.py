...
SAL = S + r"\Motor_2608_julio_vig30_cota_inferior.xlsx"
...
with pd.ExcelWriter(S + r"\SoloMes_2608_pares_v3.xlsx", engine="xlsxwriter") as w:
...
p.to_pickle(S + r"\pares_solo_mes_v3.pkl")
